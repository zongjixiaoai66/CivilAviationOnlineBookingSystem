...
public class JipiaoCollectionView extends JipiaoCollectionEntity implements Serializable {
	...
	*/
	...
	private String jipiaoCollectionValue;
	...
	public JipiaoCollectionView() {

	}

	public JipiaoCollectionView(JipiaoCollectionEntity jipiaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jipiaoCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getJipiaoCollectionValue() {
		return jipiaoCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setJipiaoCollectionValue(String jipiaoCollectionValue) {
		this.jipiaoCollectionValue = jipiaoCollectionValue;
	}
	...
	public String toString() {
		return "JipiaoCollectionView{" +
			", jipiaoCollectionValue=" + jipiaoCollectionValue +
