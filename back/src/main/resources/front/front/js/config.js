...
var centerMenu = [
    ...
    ,{
        name: '航班收藏',
        url: '../jipiaoCollection/list.html'
    }
    ,{
        name: '机票预订',
        url: '../jipiaoOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/mhwangshangdingpiao/admin/dist/index.html#/login";
